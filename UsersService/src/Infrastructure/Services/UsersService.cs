...
namespace Infrastructure.Services
{
    public class UsersService : IUsersService
    {
        ...
        {
            return await Result<List<GetUserDTO>>.SuccessAsync(_mapper
                                                               .Map<List<GetUserDTO>>((await _unitOfWork
                                                                                             .UsersRepository
                                                                                             .GetAllUsersAsync())
                                                                                             .Data));
        }
        ...
        {
            return await Result<GetUserDTO?>.SuccessAsync(_mapper
                                                          .Map<GetUserDTO?>((await _unitOfWork
                                                                                   .UsersRepository
                                                                                   .GetByGuidAsync(guid))
                                                                                   .Data));
        }
